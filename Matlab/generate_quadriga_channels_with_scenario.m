function generate_quadriga_channels_with_scenario(A, positions, B, desired_mean, desired_std, seed, scenario, num_samples, output_dir)
...
%     H_all: [num_samples x B x n x n] complex SISO channel tensor
    ...
    % -------------------- Save --------------------
    save(fullfile(output_dir, 'H_all.mat'), 'H_all', '-v7.3');
    disp(['✅ Saved full channel tensor H_all to ', fullfile(output_dir, 'H_all.mat')]);
end
